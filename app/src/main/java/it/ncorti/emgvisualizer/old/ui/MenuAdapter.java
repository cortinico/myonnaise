...
*/
package it.ncorti.emgvisualizer.old.ui;
...
import it.ncorti.emgvisualizer.old.model.EventBusProvider;
...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.ViewHolder> {
  ...
  public MenuAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    if (viewType == TYPE_ITEM) {
      ...
      View v =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.menu_header, parent, false);
      return new ViewHolder(v, viewType);
    } else if (viewType == TYPE_SEPARATOR) {
      View v =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.menu_row_title, parent, false);
      return new ViewHolder(v, viewType);
    }
    return null;
  }
  ...
  public int getItemViewType(int position) {
    ...
    else if (menuIcons[position - 1] == -1) return TYPE_SEPARATOR;
    return TYPE_ITEM;
  }
  ...
  public void updateSelectedItem(int newSelectedItem) {
    if (selectedPosition == newSelectedItem || selectedPosition > getItemCount()) return;
  ...
  public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    ViewHolder(View itemView, int ViewType) {
      super(itemView);
      if (ViewType == TYPE_ITEM) {
        txtEntry = itemView.findViewById(R.id.menu_txt_entry);
        imgMenuIcon = itemView.findViewById(R.id.menu_img_icon);
        this.globalView = itemView;
      } else if (ViewType == TYPE_SEPARATOR) {
        txtEntry = itemView.findViewById(R.id.menu_txt_separator);
        this.globalView = itemView;
      }
      Holderid = ViewType;
    }
